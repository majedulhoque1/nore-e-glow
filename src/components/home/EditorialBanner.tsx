...
const EditorialBanner = () => (
  <section className="relative bg-noir overflow-hidden">
    ...
    <motion.div
      ...
      className="grid grid-cols-1 md:grid-cols-12 min-h-0 md:min-h-[600px] max-w-[1400px] mx-auto"
    >
      {/* Content */}
      <div className="md:col-span-5 md:col-start-2 px-6 py-6 md:px-0 md:py-24 flex flex-col justify-center order-2 md:order-1 relative z-[1]">
        <motion.div
        ...
        <motion.h2
          ...
          className="font-display font-light text-ivory mt-3 md:mt-6 leading-[1.05]"
        ...
        <motion.p
          ...
          className="font-body font-light text-ivory/70 mt-3 md:mt-6 text-sm md:text-base leading-relaxed max-w-[420px]"
        >
          Candy bead and stone chip phone straps — small heirlooms for daily life.
        </motion.p>
        ...
        <motion.div
          ...
          className="mt-5 md:mt-10 flex items-center gap-6"
        >
          <Link
            to="/category/phone-charms"
            className="group inline-flex items-center gap-2 border border-gold text-gold font-body text-[11px] md:text-[12px] uppercase tracking-[0.18em] px-5 md:px-7 py-2.5 md:py-3.5 rounded-[2px] hover:bg-gold hover:text-bark transition-all duration-300 active:scale-[0.97]"
          >
            Shop Phone Charms
      ...
      {/* Image */}
      <div className="md:col-span-6 md:col-start-7 relative h-[42vh] max-h-[340px] md:max-h-none md:h-auto order-1 md:order-2 overflow-hidden">
        <motion.img
          initial={{ scale: 1.08 }}
          whileInView={{ scale: 1 }}
          viewport={{ once: true }}
