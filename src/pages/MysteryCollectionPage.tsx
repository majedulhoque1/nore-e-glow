...
import { Sparkles, Gift, Truck, Tag, Package } from 'lucide-react';
...
const MysteryCollectionPage = () => {
  ...
  return (
    <div className="min-h-screen bg-ivory">
      <SEOHead
        title="Mystery Collection — Curated Surprises"
              ...
              <button
                ...
                title={
                  isActive
                    ...
                    : isCompleted
                      ? 'Sold out. Thank you!'
                      : 'This collection is not available yet. Check back soon.'
                }
              >
